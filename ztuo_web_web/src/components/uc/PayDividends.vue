            ...
            <div class="bill_box rightarea padding-right-clear record">
                <div class="col-xs-12 rightarea-con">
                    ...
                    <div class="form-group" style="display:none;">
                        ...
                        <Button type="primary" @click="queryOrder" style="padding: 6px 50px;margin-left:10px;background-color:#3399ff;border-color:#3399ff">{{$t('uc.finance.paydividende.search')}}</Button>
                    </div>
                    <!-- 隐藏结尾 -->
                    ...
                    <div class="order-table">
                        <Table stripe :no-data-text="$t('common.nodata')" :columns="tableColumnsRecord" :data="tableRecord" :loading="loading"></Table>

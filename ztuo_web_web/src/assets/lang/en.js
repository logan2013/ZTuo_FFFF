...
module.exports = {
    ...
    footer: footer,
    topInfo: {
        name: 'XX网--International Digital encryption asset trading platform',
    },
    common: {
        login: 'Log In',
        register: 'Sign Up',
    ...
    description: {
        ...
        // message3: 'XX网 Exchange supports 10,00 transactions per second, giving users a hearty transaction experience',
        message4: 'Multi-terminal APP, easily traded between',
        message5: 'XX网 international digital encryption asset trading platform mobile client, focusing on palm trading experience',
    },
    index: {

		...
		<Row type="flex" justify="space-between" class="dashBoard">
			...
			<Card>
				...
				<div class="cardBody">
					<Row>
						<Col span="8">注册用户</Col>
						<Col span="8">{{ memberBoardInfo.registrationNum || 0 }}</Col>
						<Col span="8">{{ memberBoardInfo.yesterdayRegistrationNum || 0 }}</Col>
					</Row>
					<Row>
						<Col span="8">实名用户</Col>
						<Col span="8">{{ memberBoardInfo.applicationNum || 0 }}</Col>
						<Col span="8">{{ memberBoardInfo.yesterdayApplicationNum || 0 }}</Col>
					</Row>
					<Row>
						<Col span="8">认证商家</Col>
						<Col span="8">{{ memberBoardInfo.bussinessNum || 0 }}</Col>
						<Col span="8">{{ memberBoardInfo.yesterdayBussinessNum || 0 }}</Col>
					</Row>
					<!-- <Row>
							<Col span="8">交易用户</Col>
							<Col span="8">累计</Col>

...
//POST "币币管理" => "查询所有拉升币种"
export const queryInit = data => post('admin/exchange_init/query', data);

//POST "币币管理" => "添加拉升币种"
export const addInit = data => post('admin/exchange_init/add', data);

//POST "币币管理" => "删除拉升币种"
export const delInit = id => fetch(`admin/exchange_init/delete/${id}`);

//POST "币币管理" => "编辑拉升币种"
export const editorInit = data => post("admin/exchange_init/update", data);
...
//POST "会员管理" => "余额管理" => "法币账户"
export const paperAsset = data => post('/admin/member/member-wallet/otc/balance', data);
...
//get "会员管理" => "会员详情" => "法币账户"
export const paper = memberId => fetch(`/admin/member/member-wallet/otc/query/${memberId}`);

//post "会员管理" => "会员详情"=>"锁定法币"
export const lockPaper = data => post('/admin/member/member-wallet/otc/lock-wallet', data);

//post "会员管理" => "会员详情"=>"解锁法币"
export const unlockPaper = data => post('/admin/member/member-wallet/otc/unlock-wallet', data);

//post "会员管理" => "会员详情"=>"锁定法币"
export const lockLeavel = data => post('/admin/lever/lever_coin/lock_wallet', data);
...
//POST获取 "首页"=>"获取验证码后登录"
export const signIn = data => post('admin/system/employee/googleAuth/sign/in', data);
...
//新的接口获取所有等级
export const getAllLevel = () => fetch('admin/member/grade/all');

//更新会员等级的信息
export const editLevelMsg = (data) => postConfig('admin/member/grade/update', data);

//设置lv6
export const editLvSix = data => post('admin/member/update', data);

//糖果发放设置
export const giftSetting = data => postConfig('admin/gift/page-query', data);

//糖果发放记录
export const giftRecord = data => postConfig('admin/gift/record/page-query', data);

//查询平台所有币种
export const allUnit = () => post("admin/system/coin/all");

//添加糖果
export const addGift = (data) => postConfig('admin/gift/save', data);
...
//获取所有积分记录
export const allIntegralRecord = data => postConfig('admin/integration/record/query_page', data);

//注册送币查询
export const registerGiftRecord = data => postConfig('admin/system/reward-activity-record/page-query', data);

//注册送币审核列表查询
export const registerGiftExamineRecord = data => postConfig('admin/release/conditionQueryAll', data);

//注册送币审核列表添加
export const registerGiftExamineAdd = data => post('admin/system/reward-activity-record/merge', data);

//注册送币删除配置
export const registerGiftExamineDelete = data => post('admin/system/reward-activity-record/deletes', data);

//送币审核
export const GiftExamine = data => postConfig('admin/release/updateReleaseBalance', data);

//查询所有IEO管理
export const AllIeoRecord = data => postConfig('admin/ieo/page-query', data);

//新增IEO或者修改预热中的IEO
export const addIEO = data => postConfig('admin/ieo/save', data);

//删除预热中的IEO项目
export const deleteIEO = id => fetch(`admin/ieo/del/${id}`);

/// 查询认购记录
export const allBuyRecord = data => postConfig('admin/ieo/record/page-query', data);

//查询所有的亏损设置
export const allDangerousRecord = data => post('admin/loss_threshold/list', data);

//创建亏损阀值
export const addMaxDangerous = data => post("admin/loss_threshold/create", data);

//查询所有的亏损设置的币种
export const allDangerousUnit = () => fetch("admin/lever/lever_coin/find_all");

//删除某项亏损设置
export const deleteDangerous = data => post('admin/loss_threshold/delete', data);

//编辑某项亏损设置
export const editDangerous = data => post('admin/loss_threshold/update', data);


//修改会员密码
export const editMenmberPassword = data => post('/admin/member/reset/pwd', data);

//币种管理新增token
export const addtoken = data => post('admin/system/coinToken/saveCoinName', data)

//币种管理查看token
export const examinetoken = data => post('admin/system/coinToken/findByCoinName', data)

//币种管理删除token
export const deltoken = data => post('admin/system/coinToken/delete', data)